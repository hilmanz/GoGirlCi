            ...
            <figure class="item col-md-4">
				...
				{/if}
                    ...
                    <div class="entry-post">
                        ...
                        <a href="{$basedomain}event/detail/{$listcontent[i].id}/{$listcontent[i].titleurl}" class="readmore"><i class="icon-arrow-right"></i></a>
                    </div>
                </figcaption>
            </figure>
          {/section}
...
$(document).bind('scroll','.galleryList', function()
		...
		$.each(result.data,function(k,v){  
		    ...
		    str+='<figcaption>';
			str+='<a class="thumb thumb-medium" href="'+basedomain+'event/detail/'+v.id+'/'+v.titleurl+'">';
			str+='<img src="'+basedomain+'public_assets/imgregistrasi/'+v.img+'"/>';
			str+='</a>';
		    str+='<h4><a href="'+basedomain+'event/detail/'+v.id+'/'+v.titleurl+'">'+v.title+'</a></h4>';
			str+='<div class="meta-container">';
			str+='<a href="'+basedomain+'event/detail/'+v.id+'/'+v.titleurl+'">';
			...
			str+='<a class="fb-share" href="javascript:void(0)" onclick="shareFB('+v.titleshare+','+basedomain+'event/detail/'+v.id+'/'+v.titleurl+','+basedomain+'public_assets/imgregistrasi/'+v.img+','+v.content.substring(0,50)+')"><i class="icon-facebook">&nbsp;</i></a> ';
			str+=' <a class="twitter-share" href="http://twitter.com/share?text'+v.content.substring(0,50)+'&url='+basedomain+'event/detail/'+v.id+'/'+v.titleurl+'"  target="_blank"><i class="icon-twitter">&nbsp;</i></a>';
			str+='</p>';
            str+='</div>';
            str+='<div class="entry-post">';
            str+='<p>'+v.content+'</p>';
            str+='<a href="'+basedomain+'event/detail/'+v.id+'/'+v.titleurl+'" class="readmore"><i class="icon-arrow-right"></i></a>';
